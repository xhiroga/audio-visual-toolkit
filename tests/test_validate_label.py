from audio_visual_toolkit.validate_label import validate_label_file
...
def test_validate_label_true() -> None:
    ...
    assert validate_label_file(str(lab_path)) is True
...
def test_validate_label_false() -> None:
    ...
    assert validate_label_file(str(lab_path)) is False
